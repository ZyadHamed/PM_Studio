...
namespace PM_Studio
{
    ...
    public class Task
    {
        ...
        public Task(string _TaskTitle, string _TaskDescription, DateTime _StartDate, DateTime _EndDate, bool _IsDone = false, bool isOrderedByType = false)
        {
            Title = _TaskTitle;
            ...
            EndDate = _EndDate;
            IsDone = _IsDone;
            IsOrderedByType = isOrderedByType;
        ...
        public bool IsOrderedByType { get; set; } = false;
